...
export default function SupplierProfile() {
  ...
  const menu = [
    ...
    { to: '/supplier/profile', label: 'My Profile' }
  ];
  ...
  return (
    <DashboardShell 
      menu={menu} 
      title="My Profile" 
      subtitle={`Your supplier profile details`}
    >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className={`inline-flex items-center rounded-full px-3 py-1 text-sm font-medium ${
                  ...
                  {user.isActive ? 'Active Supplier' : 'Pending Approval'}
                </span>
              </div>
                ...
                <div>
                  ...
                  <dl className="mt-3 space-y-3">
                    ...
                    <div>
                      ...
                      <dd className="text-sm text-slate-900">{user.address || 'Not provided'}</dd>
                    </div>
                  </dl>
                </div>

                <div>
                  <h3 className="text-sm font-medium text-slate-500 uppercase tracking-wide">Supplier Details</h3>
                  <dl className="mt-3 space-y-3">
                    <div>
                    ...
                    <div>
                      <dt className="text-sm font-medium text-slate-600">Supplier ID</dt>
                      <dd className="text-sm text-slate-900">{user.uniqueId}</dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-slate-600">Supply Category</dt>
                      <dd className="text-sm text-slate-900">{user.supplyCategory || 'Tea Leaves'}</dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-slate-600">Farm Location</dt>
                      <dd className="text-sm text-slate-900">{user.farmLocation || 'Not provided'}</dd>
                    </div>
                    <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-600">Supplier Since</span>
          ...
          {/* Supply Statistics */}
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Supply Statistics</h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-600">Total Supplies</span>
