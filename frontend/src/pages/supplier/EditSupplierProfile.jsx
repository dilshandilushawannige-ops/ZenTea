...
import { updateSupplierProfile } from '../../api/authApi';
...
export default function EditSupplierProfile() {
  ...
  useEffect(() => {
    if (user) {
      setFormData({
        ...
        supplyCategory: user.supplyCategory || 'Tea Leaves',
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await updateSupplierProfile(token, formData);
      ...
      Swal.fire({
        ...
        text: 'Your supplier profile has been updated successfully',
        toast: true,
        position: 'top',
        showConfirmButton: false,
        timer: 3000
      ...
      Swal.fire({
        icon: 'error',
        title: 'Update Failed',
        text: error.response?.data?.message || 'Failed to update supplier profile',
        toast: true,
        position: 'top',
        showConfirmButton: false,
        timer: 3000
  ...
  if (!user) {
    return (
      <DashboardShell menu={menu} title="Edit Supplier Profile" subtitle="Update your supplier profile details">
  ...
  return (
    <DashboardShell 
      ...
      subtitle="Update your supplier profile details"
    >
      <div className="space-y-6">
        ...
        <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-100">
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900">Edit Supplier Profile</h2>
              <p className="text-sm text-slate-500">Update your supplier information</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Farm Location */}
              <div>
                <label htmlFor="farmLocation" className="block text-sm font-medium text-slate-700 mb-2">
                  Farm Location
                </label>
                <input
                  type="text"
              ...
              {/* Supply Category */}
              <div>
                <label htmlFor="supplyCategory" className="block text-sm font-medium text-slate-700 mb-2">
                  Supply Category
                </label>
                <select
                  id="supplyCategory"
