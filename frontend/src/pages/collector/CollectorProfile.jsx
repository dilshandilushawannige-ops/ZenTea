...
export default function CollectorProfile() {
  ...
  return (
    <DashboardShell 
      menu={menu} 
      title="My Profile" 
      subtitle={`Your collector profile details`}
    >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className={`inline-flex items-center rounded-full px-3 py-1 text-sm font-medium ${
                  ...
                  {user.isActive ? 'Active Collector' : 'Pending Approval'}
                </span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-sm font-medium text-slate-500 uppercase tracking-wide">Collector Details</h3>
                  <dl className="mt-3 space-y-3">
                    <div>
                    ...
                    <div>
                      <dt className="text-sm font-medium text-slate-600">Collector ID</dt>
                      <dd className="text-sm text-slate-900">{user.uniqueId}</dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-slate-600">Collection Area</dt>
                      <dd className="text-sm text-slate-900">{user.collectionArea || 'Not assigned'}</dd>
                    </div>
                    <div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-200">
            <div className="flex space-x-3">
              ...
              >
                ...
                Edit Collector Profile Details
              </button>
              <button 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-600">Collector Since</span>
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Collection Statistics</h3>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-slate-600">Average per Day</span>
                <span className="text-sm font-medium text-slate-900">-</span>
              </div>
            </div>
          </div>
