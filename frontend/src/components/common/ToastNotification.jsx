...
export default function ToastNotification({ type = 'info', title, message, onClose }) {
  const style = STYLE_MAP[type] || STYLE_MAP.info;

  return (
    <div className={`toast-enter pointer-events-auto flex w-80 items-start gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-xl shadow-slate-200/70 ${style.border}`}>
